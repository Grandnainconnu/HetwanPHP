...
class ServerEntity
{
     ...
     *
     * @param int $state
     * @return \Hetwan\Entity\Login\ServerEntity
     */
    public function setState(int $state) : \Hetwan\Entity\Login\ServerEntity
    {
        $this->state = $state;
     ...
     * @return \Hetwan\Entity\Login\ServerEntity
     */
    public function setPopulation(int $population) : \Hetwan\Entity\Login\ServerEntity
    {
     ...
     * @return \Hetwan\Entity\Login\ServerEntity
     */
    public function setIpAddress(string $ipAddress) : \Hetwan\Entity\Login\ServerEntity
    {
     ...
     * @return \Hetwan\Entity\Login\ServerEntity
     */
    public function setPort($port) : \Hetwan\Entity\Login\ServerEntity
    {
        $this->port = $port;
