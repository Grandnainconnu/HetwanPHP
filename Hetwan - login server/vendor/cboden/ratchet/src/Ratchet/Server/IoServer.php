...
class IoServer {
     ...
     * @return IoServer
     */
    public static function factory(MessageComponentInterface $component, $uri = '0.0.0.0:80', $loop = null) {
        if (null == $loop)
    ...
    public function handleConnect($conn) {
        ...
        $conn->on('error', function ($exception) use ($conn) {
            $this->handleError($exception, $conn);
        });
    }
